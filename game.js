let guessGame = _.before(3, guessNumber); // to limit the number of times fuction i called.
function guessNumber() {
  let number = (Math.random() * 5) | 1, // have set Maximum value to 5 and minimun value to 1
    guess,
